...
def create_app() -> FastAPI:
    app = FastAPI(
        title="VehiTrack Identity Service", 
        version="1.0.0",
        docs_url="/api/v1/identity/docs",
        openapi_url="/api/v1/identity/openapi.json"
    )
    ...
    @app.get("/health")
    def health(): return {"status": "healthy", "service": "identity-service"}
